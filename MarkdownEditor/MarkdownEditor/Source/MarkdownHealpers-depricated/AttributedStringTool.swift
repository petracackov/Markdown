...
//        let rangesWithoutFont = attributedString.rangesWithMissingAttribute(for: .font)
...
//        let rangesWithoutFont = attributedString.rangesWithMissingAttribute(for: .paragraphStyle)
//        rangesWithoutFont.forEach {
